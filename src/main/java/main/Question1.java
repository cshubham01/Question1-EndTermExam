...
class ECE extends Courses { //extend the parent class here 
	public String displayCourseDetails(String dept) {
		...
		String commonSubjects = cs.displayCourseDetails("ECE");//call the parent function after using inheritence
		...
		String specificSubjects = dept+" specific subjects are:\n4. "+subject1+"\n5. "+subject2;
		return commonSubjects+specificSubjects;
...
class Mechanical extends Courses { //extend the parent class here 
	public String displayCourseDetails(String dept) {
		// write or edit your code here 
		Courses cs = new Courses();
		String commonSubjects = cs.displayCourseDetails("Mechanical");//call the parent function after using inheritence
...
class CSE extends Courses  { //extend the parent class here 
	public String displayCourseDetails(String dept) {
		...
		// write or edit your code here 
		Courses cs = new Courses();
		String commonSubjects = cs.displayCourseDetails("CSE");//call the parent function after using inheritence
